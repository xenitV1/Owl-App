...
interface PostCreationFormProps {
  onPostCreated?: () => void;
  onSubmit?: (postData: { title: string; content: string; subject: string; image: File | null }) => Promise<void>;
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <Select value={subject} onValueChange={setSubject}>
              <SelectTrigger>
                <SelectValue placeholder={t('posts.selectSubjectPlaceholder')} />
              </SelectTrigger>
              <SelectContent>
                {SUBJECTS.map((subj) => (
