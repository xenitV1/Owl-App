  ...
  apps: [{
    ...
    deploy: {
      production: {
        ...
        'post-deploy': 'npm ci --only=production && npm run build && pm2 reload owl-platform --update-env',
        'pre-setup': 'mkdir -p /var/www/owl-platform /var/backups/owl-platform /var/log/owl-platform'
      }
    }
  }]
};